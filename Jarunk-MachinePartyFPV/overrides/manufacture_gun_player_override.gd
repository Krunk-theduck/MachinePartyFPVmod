extends "res://minigames/manufacture_gun/components/player/scripts/manufacture_gun_player.gd"
...
func _process(delta: float) -> void:
	...
	if fpv:
		...
		print("[fpv_mod][manufacture_gun_override] FirstPersonViewController node not found under /root -- movement override is not running")
